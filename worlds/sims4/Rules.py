...
def set_completion_condition(world: MultiWorld, player: int, options: Sims4Options):
    ...
    if goal_value == goal.option_bodybuilder:
        world.completion_condition[player] = lambda state: state.has(Aspiration.BODYBUILDER.item_name, player)
    elif goal_value == goal.option_painter_extraordinaire:
        world.completion_condition[player] = lambda state: state.has(Aspiration.PAINTER_EXTRAORDINAIRE.item_name, player)
    elif goal_value == goal.option_bestselling_author:
        world.completion_condition[player] = lambda state: state.has(Aspiration.BESTSELLING_AUTHOR.item_name, player)
    elif goal_value == goal.option_musical_genius:
        world.completion_condition[player] = lambda state: state.has(Aspiration.MUSICAL_GENIUS.item_name, player)
    elif goal_value == goal.option_public_enemy:
        world.completion_condition[player] = lambda state: state.has(Aspiration.PUBLIC_ENEMY.item_name, player)
    elif goal_value == goal.option_chief_of_mischief:
        world.completion_condition[player] = lambda state: state.has(Aspiration.CHIEF_OF_MISCHIEF.item_name, player)
    elif goal_value == goal.option_master_chef:
        world.completion_condition[player] = lambda state: state.has(Aspiration.MASTER_CHEF.item_name, player)
    elif goal_value == goal.option_master_mixologist:
        world.completion_condition[player] = lambda state: state.has(Aspiration.MASTER_MIXOLOGIST.item_name, player)
    elif goal_value == goal.option_renaissance_sim:
        world.completion_condition[player] = lambda state: state.has(Aspiration.RENAISSANCE_SIM.item_name, player)
    elif goal_value == goal.option_nerd_brain:
        world.completion_condition[player] = lambda state: state.has(Aspiration.NERD_BRAIN.item_name, player)
    elif goal_value == goal.option_computer_whiz:
        world.completion_condition[player] = lambda state: state.has(Aspiration.COMPUTER_WHIZ.item_name, player)
    elif goal_value == goal.option_serial_romantic:
        world.completion_condition[player] = lambda state: state.has(Aspiration.SERIAL_ROMANTIC.item_name, player)
    elif goal_value == goal.option_freelance_botanist:
        world.completion_condition[player] = lambda state: state.has(Aspiration.FREELANCE_BOTANIST.item_name, player)
    elif goal_value == goal.option_the_curator:
        world.completion_condition[player] = lambda state: state.has(Aspiration.THE_CURATOR.item_name, player)
    elif goal_value == goal.option_angling_ace:
        world.completion_condition[player] = lambda state: state.has(Aspiration.ANGLING_ACE.item_name, player)
    elif goal_value == goal.option_joke_star:
        world.completion_condition[player] = lambda state: state.has(Aspiration.JOKE_STAR.item_name, player)
    elif goal_value == goal.option_friend_of_the_world:
        world.completion_condition[player] = lambda state: state.has(Aspiration.FRIEND_OF_THE_WORLD.item_name, player)
    elif goal_value == goal.option_neighborly_advisor:
        world.completion_condition[player] = lambda state: state.has(Aspiration.NEIGHBORLY_ADVISOR.item_name, player)
...
def _bodybuilder(world: MultiWorld, player: int):
    set_rule(world.get_location(base_aspiration_exercise_demon, player),
             lambda state: has_skill(state, SkillNames.base_skill_fitness, player, 4))
    set_rule(world.get_location(base_aspiration_fit_to_a_t, player),
             lambda state: has_skill(state, SkillNames.base_skill_fitness, player, 6))
    set_rule(world.get_location(base_aspiration_bodybuilder, player),
             lambda state: has_skill(state, SkillNames.base_skill_fitness, player, 10))
    set_rule(world.get_location(Aspiration.BODYBUILDER.aspiration_name, player),
             lambda state: state.can_reach(world.get_location(base_aspiration_bodybuilder, player), player=player))

def _painter_extraordinaire(world: MultiWorld, player: int):
    set_rule(world.get_location(base_aspiration_fine_artist, player),
             lambda state: has_skill(state, SkillNames.base_skill_painting, player, 4))
    set_rule(world.get_location(base_aspiration_brushing_with_greatness, player),
             lambda state: has_skill(state, SkillNames.base_skill_painting, player, 6))
    set_rule(world.get_location(base_aspiration_painter_extraordinaire, player),
             lambda state: has_skill(state, SkillNames.base_skill_painting, player, 10))
    set_rule(world.get_location(Aspiration.PAINTER_EXTRAORDINAIRE.aspiration_name, player),
             lambda state: state.can_reach(world.get_location(base_aspiration_painter_extraordinaire, player),
                                           player=player))

def _bestselling_author(world: MultiWorld, player: int):
    set_rule(world.get_location(base_aspiration_competent_wordsmith, player),
             lambda state: has_skill(state, SkillNames.base_skill_writing, player, 4))
    set_rule(world.get_location(base_aspiration_novelest_novelist, player),
             lambda state: has_skill(state, SkillNames.base_skill_writing, player, 6))
    set_rule(world.get_location(base_aspiration_bestselling_author, player),
             lambda state: has_skill(state, SkillNames.base_skill_writing, player, 10))
    set_rule(world.get_location(Aspiration.BESTSELLING_AUTHOR.aspiration_name, player),
             lambda state: state.can_reach(
                 world.get_location(base_aspiration_bestselling_author, player), player=player))

def _musical_genius(world: MultiWorld, player: int):
    set_rule(world.get_location(base_aspiration_fine_tuned, player),
    ...
    set_rule(world.get_location(base_aspiration_harmonious, player),
    ...
    set_rule(world.get_location(base_aspiration_musical_genius, player),
    ...
    set_rule(world.get_location(Aspiration.MUSICAL_GENIUS.aspiration_name, player),
             lambda state: state.can_reach(
                 world.get_location(base_aspiration_musical_genius, player), player=player))

def _public_enemy(world: MultiWorld, player: int):
    set_rule(world.get_location(base_aspiration_criminal_mind, player),
             lambda state: has_skill(state, SkillNames.base_skill_mischief, player, 3))
    set_rule(world.get_location(base_aspiration_public_enemy, player),
    ...
    set_rule(world.get_location(Aspiration.PUBLIC_ENEMY.aspiration_name, player),
             lambda state: state.can_reach(
                 world.get_location(base_aspiration_public_enemy, player), player=player))

def _chief_of_mischief(world: MultiWorld, player: int):
    set_rule(world.get_location(base_aspiration_artful_trickster, player),
             lambda state: has_skill(state, SkillNames.base_skill_mischief, player, 3))
    set_rule(world.get_location(base_aspiration_professional_prankster, player),
             lambda state: has_skill(state, SkillNames.base_skill_mischief, player, 6))
    set_rule(world.get_location(base_aspiration_chief_of_mischief, player),
             lambda state: has_skill(state, SkillNames.base_skill_mischief, player, 10))
    set_rule(world.get_location(Aspiration.CHIEF_OF_MISCHIEF.aspiration_name, player),
             lambda state: state.can_reach(
                 world.get_location(base_aspiration_chief_of_mischief, player), player=player))

def _master_chef(world: MultiWorld, player: int):
    set_rule(world.get_location(base_aspiration_captain_cook, player),
             lambda state: has_skill(state, SkillNames.base_skill_cooking, player, 5))
    set_rule(world.get_location(base_aspiration_culinary_artist, player),
             lambda state: has_skill(state, SkillNames.base_skill_cooking, player, 5))
    set_rule(world.get_location(base_aspiration_master_chef, player),
    ...
    set_rule(world.get_location(Aspiration.MASTER_CHEF.aspiration_name, player),
             lambda state: state.can_reach(
                 world.get_location(base_aspiration_master_chef, player), player=player))

def _master_mixologist(world: MultiWorld, player: int):
    set_rule(world.get_location(base_aspiration_electric_mixer, player),
             lambda state: has_skill(state, SkillNames.base_skill_mixology, player, 4))
    set_rule(world.get_location(base_aspiration_beverage_boss, player),
    ...
    set_rule(world.get_location(base_aspiration_master_mixologist, player),
             lambda state: has_skill(state, SkillNames.base_skill_mixology, player, 10)
                           and has_skill(state, SkillNames.base_skill_cooking, player, 4))
    set_rule(world.get_location(Aspiration.MASTER_MIXOLOGIST.aspiration_name, player),
             lambda state: state.can_reach(
                 world.get_location(base_aspiration_master_mixologist, player), player=player))
def _renaissance_sim(world: MultiWorld, player: int):
    set_rule(world.get_location(base_aspiration_prudent_student, player),
             lambda state: state.has(SkillNames.base_skill_logic, player, count=1))
    set_rule(world.get_location(base_aspiration_jack_of_some_trades, player),
             lambda state: count_skills_over(2, state, player) >= 4)
    set_rule(world.get_location(base_aspiration_pantologist, player),
             lambda state: count_skills_over(3, state, player) >= 5)
    set_rule(world.get_location(base_aspiration_renaissance_sim, player),
             lambda state: count_skills_over(6, state, player) >= 6)
    set_rule(world.get_location(Aspiration.RENAISSANCE_SIM.aspiration_name, player),
             lambda state: state.can_reach(
                 world.get_location(base_aspiration_renaissance_sim, player), player=player))

def _nerd_brain(world: MultiWorld, player: int):
    set_rule(world.get_location(base_aspiration_prudent_student, player),
             lambda state: has_skill(state, SkillNames.base_skill_logic, player, 3))
    set_rule(world.get_location(base_aspiration_erudite, player),
             lambda state: has_skill(state, SkillNames.base_skill_logic, player, 6))
    set_rule(world.get_location(base_aspiration_rocket_scientist, player),
             lambda state: has_skill(state, SkillNames.base_skill_handiness, player, 5))
    set_rule(world.get_location(base_aspiration_nerd_brain, player),
    ...
    set_rule(world.get_location(Aspiration.NERD_BRAIN.aspiration_name, player),
             lambda state: state.can_reach(
                 world.get_location(base_aspiration_nerd_brain, player), player=player))

def _computer_whiz(world: MultiWorld, player: int):
    set_rule(world.get_location(base_aspiration_technically_adept, player),
             lambda state: has_skill(state, SkillNames.base_skill_programming, player, 3))
    set_rule(world.get_location(base_aspiration_computer_geek, player),
             lambda state: has_skill(state, SkillNames.base_skill_programming, player, 7))
    set_rule(world.get_location(base_aspiration_computer_whiz, player),
             lambda state: has_skill(state, SkillNames.base_skill_programming, player, 7)
                           and has_skill(state, SkillNames.base_skill_video_gaming, player, 4))
    set_rule(world.get_location(Aspiration.COMPUTER_WHIZ.aspiration_name, player),
             lambda state: state.can_reach(
                 world.get_location(base_aspiration_computer_whiz, player), player=player))

def _serial_romantic(world: MultiWorld, player: int):
    set_rule(world.get_location(base_aspiration_up_to_date, player),
             lambda state: has_skill(state, SkillNames.base_skill_charisma, player, 4))
    set_rule(world.get_location(base_aspiration_romance_juggler, player),
             lambda state: has_skill(state, SkillNames.base_skill_charisma, player, 6))
    set_rule(world.get_location(base_aspiration_serial_romantic, player),
             lambda state: has_skill(state, SkillNames.base_skill_charisma, player, 6))
    set_rule(world.get_location(Aspiration.SERIAL_ROMANTIC.aspiration_name, player),
             lambda state: state.can_reach(
                 world.get_location(base_aspiration_serial_romantic, player), player=player))

def _freelance_botanist (world: MultiWorld, player: int):
    set_rule(world.get_location(base_aspiration_garden_variety, player),
             lambda state: has_skill(state, SkillNames.base_skill_gardening, player, 4))
    set_rule(world.get_location(base_aspiration_nature_nurturer, player),
             lambda state: has_skill(state, SkillNames.base_skill_gardening, player, 6))
    set_rule(world.get_location(base_aspiration_freelance_botanist, player),
             lambda state: has_skill(state, SkillNames.base_skill_gardening, player, 10))
    set_rule(world.get_location(Aspiration.FREELANCE_BOTANIST.aspiration_name, player),
             lambda state: state.can_reach(
                 world.get_location(base_aspiration_freelance_botanist, player), player=player))

def _angling_ace(world: MultiWorld, player: int):
    set_rule(world.get_location(base_aspiration_hooked, player),
             lambda state: has_skill(state, SkillNames.base_skill_fishing, player, 4))
    set_rule(world.get_location(base_aspiration_reel_smart, player),
             lambda state: has_skill(state, SkillNames.base_skill_fishing, player, 6))
    set_rule(world.get_location(base_aspiration_angling_ace, player),
             lambda state: has_skill(state, SkillNames.base_skill_fishing, player, 10))
    set_rule(world.get_location(Aspiration.ANGLING_ACE.aspiration_name, player),
             lambda state: state.can_reach(
                 world.get_location(base_aspiration_angling_ace, player), player=player))

def _joke_star(world: MultiWorld, player: int):
    set_rule(world.get_location(base_aspiration_practical_joker, player),
             lambda state: has_skill(state, SkillNames.base_skill_comedy, player, 3))
    set_rule(world.get_location(base_aspiration_standup_startup, player),
             lambda state: has_skill(state, SkillNames.base_skill_comedy, player, 3))
    set_rule(world.get_location(base_aspiration_funny, player),
    ...
    set_rule(world.get_location(base_aspiration_joke_star, player),
             lambda state: has_skill(state, SkillNames.base_skill_comedy, player, 10)
                           and (has_skill(state, SkillNames.base_skill_guitar, player, 3)
                                or has_skill(state, SkillNames.base_skill_violin, player, 3)))
    set_rule(world.get_location(Aspiration.JOKE_STAR.aspiration_name, player),
             lambda state: state.can_reach(
                 world.get_location(base_aspiration_joke_star, player), player=player))

def _friend_of_the_world(world: MultiWorld, player: int):
    set_rule(world.get_location(base_aspiration_well_liked, player),
             lambda state: has_skill(state, SkillNames.base_skill_charisma, player, 4))
    set_rule(world.get_location(base_aspiration_super_friend, player),
             lambda state: has_skill(state, SkillNames.base_skill_charisma, player, 6))
    set_rule(world.get_location(base_aspiration_friend_of_the_world, player),
             lambda state: has_skill(state, SkillNames.base_skill_charisma, player, 10))
    set_rule(world.get_location(Aspiration.FRIEND_OF_THE_WORLD.aspiration_name, player),
             lambda state: state.can_reach(
                 world.get_location(base_aspiration_friend_of_the_world, player), player=player))

def _neighborly_advisor(world: MultiWorld, player: int):
    set_rule(world.get_location(base_aspiration_neighborly_advisor, player),
             lambda state: has_skill(state, SkillNames.base_skill_charisma, player, 7))
    set_rule(world.get_location(Aspiration.NEIGHBORLY_ADVISOR.aspiration_name, player),
             lambda state: state.can_reach(
                 world.get_location(base_aspiration_neighborly_advisor, player), player=player))

ASPIRATION_RULES = {
        aspiration_bodybuilder: _bodybuilder,
        aspiration_painter_extraordinaire: _painter_extraordinaire,
        aspiration_bestselling_author: _bestselling_author,
        aspiration_musical_genius: _musical_genius,
        aspiration_public_enemy: _public_enemy,
        aspiration_chief_of_mischief: _chief_of_mischief,
        aspiration_master_chef: _master_chef,
        aspiration_master_mixologist: _master_mixologist,
        aspiration_renaissance_sim: _renaissance_sim,
        aspiration_nerd_brain: _nerd_brain,
        aspiration_computer_whiz: _computer_whiz,
        aspiration_serial_romantic: _serial_romantic,
        aspiration_freelance_botanist: _freelance_botanist,
        aspiration_angling_ace: _angling_ace,
        aspiration_joke_star: _joke_star,
        aspiration_friend_of_the_world: _friend_of_the_world,
        aspiration_neighborhood_confidante: _neighborly_advisor,
    }

def set_aspiration_rules(world: MultiWorld, player: int, options: Sims4Options):
    handler = ASPIRATION_RULES.get(options)
    if handler:
        handler(world, player)

def _career_athlete(world: MultiWorld, player: int):
    set_rule(world.get_location(base_career_athlete_4, player),
    ...
    set_rule(world.get_location(base_career_athlete_5A, player),
    ...
    set_rule(world.get_location(base_career_athlete_5B, player),
             lambda state: state.has(SkillNames.base_skill_charisma, player, count=2)
                           and state.has(SkillNames.base_skill_fitness, player, count=2))
    set_rule(world.get_location(base_career_athlete_6A, player),
             lambda state: state.has(SkillNames.base_skill_charisma, player, count=2)
                           and state.has(SkillNames.base_skill_fitness, player, count=3))
    set_rule(world.get_location(base_career_athlete_7A, player),
             lambda state: state.has(SkillNames.base_skill_charisma, player, count=2)
                           and state.has(SkillNames.base_skill_fitness, player, count=4))
    set_rule(world.get_location(base_career_athlete_8A, player),
    ...
    set_rule(world.get_location(base_career_athlete_9A, player),
    ...
    set_rule(world.get_location(base_career_athlete_10A, player),
    ...
    set_rule(world.get_location(base_career_athlete_6B, player),
             lambda state: state.has(SkillNames.base_skill_charisma, player, count=3)
                           and state.has(SkillNames.base_skill_fitness, player, count=6))
    set_rule(world.get_location(base_career_athlete_7B, player),
             lambda state: state.has(SkillNames.base_skill_charisma, player, count=3)
                           and state.has(SkillNames.base_skill_fitness, player, count=7))
    set_rule(world.get_location(base_career_athlete_8B, player),
             lambda state: state.has(SkillNames.base_skill_charisma, player, count=4)
                           and state.has(SkillNames.base_skill_fitness, player, count=8))
    set_rule(world.get_location(base_career_athlete_9B, player),
             lambda state: state.has(SkillNames.base_skill_charisma, player, count=5)
                           and state.has(SkillNames.base_skill_fitness, player, count=8))
    set_rule(world.get_location(base_career_athlete_10B, player),
             lambda state: state.has(SkillNames.base_skill_charisma, player, count=6)
                           and state.has(SkillNames.base_skill_fitness, player, count=8))

def _career_astronaut(world: MultiWorld, player: int):
    set_rule(world.get_location(base_career_astronaut_4, player),
             lambda state: state.has(SkillNames.base_skill_logic, player, count=1))
    set_rule(world.get_location(base_career_astronaut_5, player),
             lambda state: state.has(SkillNames.base_skill_logic, player, count=2)
                           and state.has(SkillNames.base_skill_fitness, player, count=1))
    set_rule(world.get_location(base_career_astronaut_6, player),
             lambda state: state.has(SkillNames.base_skill_logic, player, count=3)
                           and state.has(SkillNames.base_skill_fitness, player, count=2))
    set_rule(world.get_location(base_career_astronaut_7, player),
             lambda state: state.has(SkillNames.base_skill_logic, player, count=3)
                           and state.has(SkillNames.base_skill_fitness, player, count=4))
    set_rule(world.get_location(base_career_astronaut_8A, player),
    ...
    set_rule(world.get_location(base_career_astronaut_8B, player),
             lambda state: state.has(SkillNames.base_skill_logic, player, count=4)
                           and state.has(SkillNames.base_skill_fitness, player, count=5))
    set_rule(world.get_location(base_career_astronaut_9A, player),
             lambda state: state.has(SkillNames.base_skill_fitness, player, count=6))
    set_rule(world.get_location(base_career_astronaut_10A, player),
             lambda state: state.has(SkillNames.base_skill_rocket_science, player, count=2)
                           and state.has(SkillNames.base_skill_fitness, player, count=8))
    set_rule(world.get_location(base_career_astronaut_9B, player),
             lambda state: state.has(SkillNames.base_skill_fitness, player, count=6))
    set_rule(world.get_location(base_career_astronaut_10B, player),
             lambda state: state.has(SkillNames.base_skill_rocket_science, player, count=2)
                           and state.has(SkillNames.base_skill_fitness, player, count=8))

def _career_business(world: MultiWorld, player: int):
    set_rule(world.get_location(base_career_business_5, player),
             lambda state: state.has(SkillNames.base_skill_charisma, player, count=1))
    set_rule(world.get_location(base_career_business_6, player),
             lambda state: state.has(SkillNames.base_skill_charisma, player, count=2))
    set_rule(world.get_location(base_career_business_7A, player),
             lambda state: state.has(SkillNames.base_skill_charisma, player, count=2)
                           and state.has(SkillNames.base_skill_logic, player, count=2))
    set_rule(world.get_location(base_career_business_7B, player),
             lambda state: state.has(SkillNames.base_skill_charisma, player, count=2)
                           and state.has(SkillNames.base_skill_logic, player, count=2))
    set_rule(world.get_location(base_career_business_8A, player),
             lambda state: state.has(SkillNames.base_skill_charisma, player, count=4)
                           and state.has(SkillNames.base_skill_logic, player, count=3))
    set_rule(world.get_location(base_career_business_9A, player),
             lambda state: state.has(SkillNames.base_skill_charisma, player, count=6)
                           and state.has(SkillNames.base_skill_logic, player, count=4))
    set_rule(world.get_location(base_career_business_10A, player),
    ...
    set_rule(world.get_location(base_career_business_8B, player),
             lambda state: state.has(SkillNames.base_skill_charisma, player, count=3)
                           and state.has(SkillNames.base_skill_logic, player, count=4))
    set_rule(world.get_location(base_career_business_9B, player),
             lambda state: state.has(SkillNames.base_skill_charisma, player, count=4)
                           and state.has(SkillNames.base_skill_logic, player, count=6))
    set_rule(world.get_location(base_career_business_10B, player),
             lambda state: state.has(SkillNames.base_skill_charisma, player, count=6)
                           and state.has(SkillNames.base_skill_logic, player, count=8))

def _career_criminal(world: MultiWorld, player: int):
    set_rule(world.get_location(base_career_criminal_4, player),
             lambda state: state.has(SkillNames.base_skill_mischief, player, count=1))
    set_rule(world.get_location(base_career_criminal_5, player),
             lambda state: state.has(SkillNames.base_skill_mischief, player, count=3))
    set_rule(world.get_location(base_career_criminal_6A, player),
             lambda state: state.has(SkillNames.base_skill_mischief, player, count=4))
    set_rule(world.get_location(base_career_criminal_6B, player),
             lambda state: state.has(SkillNames.base_skill_mischief, player, count=4))
    set_rule(world.get_location(base_career_criminal_7A, player),
             lambda state: state.has(SkillNames.base_skill_mischief, player, count=5))
    set_rule(world.get_location(base_career_criminal_8A, player),
             lambda state: state.has(SkillNames.base_skill_mischief, player, count=6))
    set_rule(world.get_location(base_career_criminal_9A, player),
    ...
    set_rule(world.get_location(base_career_criminal_10A, player),
...
def _career_culinary(world: MultiWorld, player: int):
    ...
    set_rule(world.get_location(base_career_culinary_6A, player),
    ...
    set_rule(world.get_location(base_career_culinary_6B, player),
             lambda state: state.has(SkillNames.base_skill_cooking, player, count=2)
                           and state.has(SkillNames.base_skill_mixology, player, count=2))
    set_rule(world.get_location(base_career_culinary_7A, player),
             lambda state: state.has(SkillNames.base_skill_cooking, player, count=4)
                           ...
                           and state.has(SkillNames.base_skill_mixology, player, count=2))
    set_rule(world.get_location(base_career_culinary_8A, player),
             lambda state: state.has(SkillNames.base_skill_cooking, player, count=6)
                           ...
                           and state.has(SkillNames.base_skill_mixology, player, count=2))
    set_rule(world.get_location(base_career_culinary_9A, player),
             lambda state: state.has(SkillNames.base_skill_cooking, player, count=6)
                           and state.has(SkillNames.base_skill_gourmet, player, count=4)
                           and state.has(SkillNames.base_skill_mixology, player, count=2))
    set_rule(world.get_location(base_career_culinary_10A, player),
             lambda state: state.has(SkillNames.base_skill_cooking, player, count=8)
                           ...
                           and state.has(SkillNames.base_skill_mixology, player, count=2))
    set_rule(world.get_location(base_career_culinary_7B, player),
    ...
    set_rule(world.get_location(base_career_culinary_8B, player),
             lambda state: state.has(SkillNames.base_skill_mixology, player, count=5)
                           ...
                           and state.has(SkillNames.base_skill_cooking, player, count=2))
    set_rule(world.get_location(base_career_culinary_9B, player),
             lambda state: state.has(SkillNames.base_skill_mixology, player, count=6)
                           ...
                           and state.has(SkillNames.base_skill_cooking, player, count=2))
    set_rule(world.get_location(base_career_culinary_10B, player),
...
def _career_entertainer(world: MultiWorld, player: int):
    set_rule(world.get_location(base_career_entertainer_5A, player),
    ...
    set_rule(world.get_location(base_career_entertainer_5B, player),
             lambda state: (state.has(SkillNames.base_skill_guitar, player, count=1)
                            or state.has(SkillNames.base_skill_violin, player, count=1))
                           and state.has(SkillNames.base_skill_comedy, player, count=1))
    set_rule(world.get_location(base_career_entertainer_6A, player),
             lambda state: state.has(SkillNames.base_skill_violin, player, count=2))
    set_rule(world.get_location(base_career_entertainer_7A, player),
    ...
    set_rule(world.get_location(base_career_entertainer_8A, player),
    ...
    set_rule(world.get_location(base_career_entertainer_9A, player),
    ...
    set_rule(world.get_location(base_career_entertainer_10A, player),
    ...
    set_rule(world.get_location(base_career_entertainer_6B, player),
             lambda state: state.has(SkillNames.base_skill_comedy, player, count=4))
    set_rule(world.get_location(base_career_entertainer_7B, player),
             lambda state: state.has(SkillNames.base_skill_comedy, player, count=5))
    set_rule(world.get_location(base_career_entertainer_8B, player),
             lambda state: state.has(SkillNames.base_skill_comedy, player, count=6)
                           and state.has(SkillNames.base_skill_charisma, player, count=2))
    set_rule(world.get_location(base_career_entertainer_9B, player),
             lambda state: state.has(SkillNames.base_skill_comedy, player, count=7)
                           and state.has(SkillNames.base_skill_charisma, player, count=4))
    set_rule(world.get_location(base_career_entertainer_10B, player),
             lambda state: state.has(SkillNames.base_skill_comedy, player, count=8)
                           and state.has(SkillNames.base_skill_charisma, player, count=6))

def _career_painter(world: MultiWorld, player: int):
    set_rule(world.get_location(base_career_painter_4, player),
             lambda state: state.has(SkillNames.base_skill_painting, player, count=2))
    set_rule(world.get_location(base_career_painter_5, player),
             lambda state: state.has(SkillNames.base_skill_painting, player, count=3))
    set_rule(world.get_location(base_career_painter_6, player),
             lambda state: state.has(SkillNames.base_skill_painting, player, count=4))
    set_rule(world.get_location(base_career_painter_7A, player),
             lambda state: state.has(SkillNames.base_skill_painting, player, count=5))
    set_rule(world.get_location(base_career_painter_7B, player),
             lambda state: state.has(SkillNames.base_skill_painting, player, count=5))
    set_rule(world.get_location(base_career_painter_8A, player),
             lambda state: state.has(SkillNames.base_skill_painting, player, count=6))
    set_rule(world.get_location(base_career_painter_9A, player),
             lambda state: state.has(SkillNames.base_skill_painting, player, count=7)
                           and state.has(SkillNames.base_skill_logic, player, count=2))
    set_rule(world.get_location(base_career_painter_10A, player),
             lambda state: state.has(SkillNames.base_skill_painting, player, count=8)
                           and state.has(SkillNames.base_skill_logic, player, count=4))
    set_rule(world.get_location(base_career_painter_8B, player),
             lambda state: state.has(SkillNames.base_skill_painting, player, count=6))
    set_rule(world.get_location(base_career_painter_9B, player),
             lambda state: state.has(SkillNames.base_skill_painting, player, count=7)
                           and state.has(SkillNames.base_skill_charisma, player, count=2))
    set_rule(world.get_location(base_career_painter_10B, player),
             lambda state: state.has(SkillNames.base_skill_painting, player, count=8)
                           and state.has(SkillNames.base_skill_charisma, player, count=4))
def _career_secret_agent(world: MultiWorld, player: int):
    set_rule(world.get_location(base_career_secret_agent_4, player),
             lambda state: state.has(SkillNames.base_skill_logic, player, count=1)
                           and state.has(SkillNames.base_skill_charisma, player, count=1))
    set_rule(world.get_location(base_career_secret_agent_5, player),
             lambda state: state.has(SkillNames.base_skill_logic, player, count=1)
                           and state.has(SkillNames.base_skill_charisma, player, count=1))
    set_rule(world.get_location(base_career_secret_agent_6, player),
             lambda state: state.has(SkillNames.base_skill_logic, player, count=3)
                           and state.has(SkillNames.base_skill_charisma, player, count=3))
    set_rule(world.get_location(base_career_secret_agent_7, player),
             lambda state: state.has(SkillNames.base_skill_logic, player, count=3)
                           and state.has(SkillNames.base_skill_charisma, player, count=3))
    set_rule(world.get_location(base_career_secret_agent_8A, player),
             lambda state: state.has(SkillNames.base_skill_logic, player, count=4)
                           and state.has(SkillNames.base_skill_charisma, player, count=4))
    set_rule(world.get_location(base_career_secret_agent_8B, player),
             lambda state: state.has(SkillNames.base_skill_logic, player, count=4)
                           and state.has(SkillNames.base_skill_charisma, player, count=4))
    set_rule(world.get_location(base_career_secret_agent_9A, player),
    ...
    set_rule(world.get_location(base_career_secret_agent_10A, player),
             lambda state: state.has(SkillNames.base_skill_logic, player, count=8)
                           and state.has(SkillNames.base_skill_charisma, player, count=6))
    set_rule(world.get_location(base_career_secret_agent_9B, player),
             lambda state: state.has(SkillNames.base_skill_logic, player, count=6))
    set_rule(world.get_location(base_career_secret_agent_10B, player),
             lambda state: state.has(SkillNames.base_skill_logic, player, count=8)
                           and state.has(SkillNames.base_skill_mischief, player, count=2))
    set_rule(world.get_location(base_career_secret_agent_11B, player),
             lambda state: state.has(SkillNames.base_skill_logic, player, count=8)
                           and state.has(SkillNames.base_skill_mischief, player, count=4))
def _career_style_influencer(world: MultiWorld, player: int):
    set_rule(world.get_location(base_career_style_influencer_4, player),
             lambda state: state.has(SkillNames.base_skill_writing, player, count=1))
    set_rule(world.get_location(base_career_style_influencer_5, player),
             lambda state: state.has(SkillNames.base_skill_writing, player, count=2))
    set_rule(world.get_location(base_career_style_influencer_6A, player),
    ...
    set_rule(world.get_location(base_career_style_influencer_7A, player),
    ...
    set_rule(world.get_location(base_career_style_influencer_8A, player),
    ...
    set_rule(world.get_location(base_career_style_influencer_9A, player),
    ...
    set_rule(world.get_location(base_career_style_influencer_10A, player),
    ...
    set_rule(world.get_location(base_career_style_influencer_6B, player),
             lambda state: state.has(SkillNames.base_skill_writing, player, count=3)
                           and state.has(SkillNames.base_skill_charisma, player, count=1)
                           and state.has(SkillNames.base_skill_painting, player, count=1))
    set_rule(world.get_location(base_career_style_influencer_7B, player),
             lambda state: state.has(SkillNames.base_skill_writing, player, count=4)
                           and state.has(SkillNames.base_skill_charisma, player, count=3)
                           and state.has(SkillNames.base_skill_painting, player, count=2)
                           and state.has(SkillNames.base_skill_photography, player, count=1))
    set_rule(world.get_location(base_career_style_influencer_8B, player),
             lambda state: state.has(SkillNames.base_skill_writing, player, count=5)
                           and state.has(SkillNames.base_skill_charisma, player, count=4)
                           and state.has(SkillNames.base_skill_painting, player, count=3))
    set_rule(world.get_location(base_career_style_influencer_9B, player),
             lambda state: state.has(SkillNames.base_skill_writing, player, count=6)
                           and state.has(SkillNames.base_skill_charisma, player, count=5)
                           and state.has(SkillNames.base_skill_painting, player, count=6))
    set_rule(world.get_location(base_career_style_influencer_10B, player),
             lambda state: state.has(SkillNames.base_skill_writing, player, count=7)
                           and state.has(SkillNames.base_skill_charisma, player, count=6)
                           and state.has(SkillNames.base_skill_painting, player, count=5))
def _career_tech_guru(world: MultiWorld, player: int):
    ...
    set_rule(world.get_location(base_career_tech_guru_4, player),
             lambda state: has_skill(state, SkillNames.base_skill_programming, player, 3))
    set_rule(world.get_location(base_career_tech_guru_5, player),
    ...
    set_rule(world.get_location(base_career_tech_guru_6, player),
    ...
    set_rule(world.get_location(base_career_tech_guru_7A, player),
    ...
    set_rule(world.get_location(base_career_tech_guru_7B, player),
             lambda state: state.has(SkillNames.base_skill_programming, player, count=4)
                           and state.has(SkillNames.base_skill_video_gaming, player, count=3))
    set_rule(world.get_location(base_career_tech_guru_8A, player),
             lambda state: state.has(SkillNames.base_skill_programming, player, count=4)
                           and state.has(SkillNames.base_skill_video_gaming, player, count=4))
    set_rule(world.get_location(base_career_tech_guru_9A, player),
    ...
    set_rule(world.get_location(base_career_tech_guru_10A, player),
    ...
    set_rule(world.get_location(base_career_tech_guru_8B, player),
             lambda state: state.has(SkillNames.base_skill_programming, player, count=6)
                           and state.has(SkillNames.base_skill_charisma, player, count=0))
    set_rule(world.get_location(base_career_tech_guru_9B, player),
             lambda state: state.has(SkillNames.base_skill_programming, player, count=7)
                           and state.has(SkillNames.base_skill_charisma, player, count=2))
    set_rule(world.get_location(base_career_tech_guru_10B, player),
             lambda state: state.has(SkillNames.base_skill_programming, player, count=8)
                           and state.has(SkillNames.base_skill_charisma, player, count=4))
def _career_writer(world: MultiWorld, player: int):
    set_rule(world.get_location(base_career_writer_4, player),
             lambda state: state.has(SkillNames.base_skill_writing, player, count=1))
    set_rule(world.get_location(base_career_writer_5, player),
             lambda state: state.has(SkillNames.base_skill_writing, player, count=2))
    set_rule(world.get_location(base_career_writer_6A, player),
             lambda state: state.has(SkillNames.base_skill_writing, player, count=3))
    set_rule(world.get_location(base_career_writer_6B, player),
             lambda state: state.has(SkillNames.base_skill_writing, player, count=3))
    set_rule(world.get_location(base_career_writer_7A, player),
             lambda state: state.has(SkillNames.base_skill_writing, player, count=5))
    set_rule(world.get_location(base_career_writer_8A, player),
             lambda state: state.has(SkillNames.base_skill_writing, player, count=6)
                           and state.has(SkillNames.base_skill_logic, player, count=1))
    set_rule(world.get_location(base_career_writer_9A, player),
             lambda state: state.has(SkillNames.base_skill_writing, player, count=7)
                           and state.has(SkillNames.base_skill_logic, player, count=2))
    set_rule(world.get_location(base_career_writer_10A, player),
             lambda state: state.has(SkillNames.base_skill_writing, player, count=8)
                           and state.has(SkillNames.base_skill_logic, player, count=3))
    set_rule(world.get_location(base_career_writer_7B, player),
             lambda state: state.has(SkillNames.base_skill_writing, player, count=5))
    set_rule(world.get_location(base_career_writer_8B, player),
             lambda state: state.has(SkillNames.base_skill_writing, player, count=6)
                           and state.has(SkillNames.base_skill_charisma, player, count=1))
    set_rule(world.get_location(base_career_writer_9B, player),
             lambda state: state.has(SkillNames.base_skill_writing, player, count=7)
                           and state.has(SkillNames.base_skill_charisma, player, count=2))
    set_rule(world.get_location(base_career_writer_10B, player),
             lambda state: state.has(SkillNames.base_skill_writing, player, count=8)
                           and state.has(SkillNames.base_skill_charisma, player, count=3))

CAREER_RULES = {
    base_career_athlete: _career_athlete,
    base_career_astronaut: _career_astronaut,
    base_career_business: _career_business,
    base_career_criminal: _career_criminal,
    base_career_culinary: _career_culinary,
    base_career_entertainer: _career_entertainer,
    base_career_painter: _career_painter,
    base_career_secret_agent: _career_secret_agent,
    base_career_style_influencer: _career_style_influencer,
    base_career_tech_guru: _career_tech_guru,
    base_career_writer: _career_writer,
}
