...
ASPIRATION_RULES = {
        ...
        painter_extraordinaire: _painter_extraordinaire,
        bestselling_author: _bestselling_author,
        musical_genius: _musical_genius,
        public_enemy: _public_enemy,
        chief_of_mischief: _chief_of_mischief,
        master_chef: _master_chef,
        master_mixologist: _master_mixologist,
        renaissance_sim: _renaissance_sim,
        nerd_brain: _nerd_brain,
        computer_whiz: _computer_whiz,
        serial_romantic: _serial_romantic,
        freelance_botanist: _freelance_botanist,
        angling_ace: _angling_ace,
        joke_star: _joke_star,
        friend_of_the_world: _friend_of_the_world,
        neighborly_advisor: _neighborly_advisor,
    }
